...
<template>
  <section id="newsletter" class="NewsLetter">
    <div class="container">
      <h2 class="title">Langganan ke buletin mingguan kami.</h2>
      ...
      <p class="help">
        Anda bisa membaca isu-isu sebelumnya dan mendengarkan podcast kami di
        <VTLink
          class="link"
          href="https://news.vuejs.org/"
          no-icon
        >news.vuejs.org</VTLink>. Anda juga dapat pergi sosial di
        <VTLink class="link" href="https://twitter.com/vuejs" no-icon>Twitter</VTLink>, atau gabung beranda kami di
